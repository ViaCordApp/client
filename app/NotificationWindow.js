...
var NotificationWindow = (function (_EventEmitter) {
  function NotificationWindow(mainWindow, _ref) {
    ...
    _ipc2['default'].on('NOTIFICATIONS_CLEAR', this.handleNotificationsClear);
    _ipc2['default'].on('NOTIFICATION_SHOW', this.handleNotificationShow);
    _ipc2['default'].on('NOTIFICATION_CLICK', this.handleNotificationClick);
    _ipc2['default'].on('NOTIFICATION_CLOSE', this.handleNotificationClose);
  }
  ...
  _createClass(NotificationWindow, [{
    ...
    value: function close() {
      ...
      _ipc2['default'].removeListener('NOTIFICATIONS_CLEAR', this.handleNotificationsClear);
      _ipc2['default'].removeListener('NOTIFICATION_SHOW', this.handleNotificationShow);
      _ipc2['default'].removeListener('NOTIFICATION_CLICK', this.handleNotificationClick);
      _ipc2['default'].removeListener('NOTIFICATION_CLOSE', this.handleNotificationClose);
    }
  }, {
    ...
    value: function createWindow() {
      ...
      this.notificationWindow = new _BrowserWindow2['default']({
        title: this.title,
        frame: false,
        resizable: false,
        show: false,
