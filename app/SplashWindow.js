...
var SplashWindow = (function (_EventEmitter) {
  ...
  _createClass(SplashWindow, [{
    ...
    value: function _launchSplashWindow() {
      ...
      this.splashWindow = new _BrowserWindow2['default']({
      ...
      _ipc2['default'].on('SPLASH_SCREEN_READY', function () {
        _this2.splashWindow.show();

        if (_singleInstance2['default'].releaseChannel === 'development') {
          var FAKE_DELAY = 2000;
          setTimeout(function () {
